    ...
    <Drawer open={open} onOpenChange={(o) => { if (!o) onClose(); }}>
      ...
      <div className="flex items-center justify-between px-6 py-5 border-b border-slate-200 bg-slate-50 shrink-0">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-md bg-blue-50 text-blue-600 flex items-center justify-center border border-blue-100 shadow-sm">
            <LinkIcon className="w-4.5 h-4.5" />
          </div>
          <div>
            <h2 className="text-base font-black text-slate-900 tracking-tight">添加 Link Type</h2>
            <p className="text-[11px] text-slate-500 font-medium mt-0.5">创建两个 Object Type 之间的新关联定义并安全管理</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <button className="text-[12px] font-bold text-slate-500 hover:text-slate-800 flex items-center gap-1 bg-white hover:bg-slate-100 border border-slate-200 px-2.5 py-1.5 rounded-md transition-colors cursor-pointer">
      ...
      <div className="bg-slate-100/70 border-b border-slate-200/40 px-6 py-3 shrink-0 flex items-center justify-between text-[11px] text-slate-500 font-medium">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6 scrollbar-thin">
        ...
        {/* Block 1: 关系基础信息 */}
        <section className="bg-white border border-slate-200/90 rounded-md p-5 shadow-3xs space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <input 
                ...
                className="w-full px-3 py-2 bg-slate-50/45 hover:bg-slate-50/80 focus:bg-white border border-slate-200 hover:border-slate-300 rounded-md text-xs text-slate-800 font-mono focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 placeholder:font-sans placeholder:text-slate-400 transition-all duration-200 shadow-3xs" 
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <input 
                ...
                placeholder="例如: 映射到"
                className="w-full px-3 py-2 bg-slate-50/45 hover:bg-slate-50/80 focus:bg-white border border-slate-200 hover:border-slate-300 rounded-md text-xs text-slate-800 font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 placeholder:text-slate-400 transition-all duration-200 shadow-3xs" 
              />
            </div>
            ...
            <div className="col-span-2 space-y-1.5">
              ...
              <textarea 
                ...
                className="w-full px-3 py-2 bg-slate-50/45 hover:bg-slate-50/80 focus:bg-white border border-slate-200 hover:border-slate-300 rounded-md text-xs text-slate-800 leading-relaxed focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 placeholder:text-slate-400 resize-none transition-all duration-200 shadow-3xs"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <select 
                  ...
                  className="w-full pl-3 pr-8 py-2 bg-slate-50/45 hover:bg-slate-50/80 focus:bg-white border border-slate-200 hover:border-slate-300 rounded-md text-xs text-slate-800 font-semibold appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 transition-all duration-200 shadow-3xs"
                >
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <select 
                  ...
                  className="w-full pl-3 pr-8 py-2 bg-slate-50/45 hover:bg-slate-50/80 focus:bg-white border border-slate-200 hover:border-slate-300 rounded-md text-xs text-slate-800 font-mono font-bold appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 transition-all duration-200 shadow-3xs"
                >
        ...
        <section className="bg-white border border-slate-200/90 rounded-md p-5 shadow-3xs space-y-4">
          ...
          <div className="bg-indigo-50/20 border border-indigo-100/60 p-4 rounded-md space-y-4 animate-fade-in">
            <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-3">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <select 
                    ...
                    className="w-full pl-3 pr-8 py-2 bg-slate-50/45 hover:bg-slate-50/80 focus:bg-white border border-slate-200 hover:border-slate-300 rounded-md text-xs font-mono font-bold text-slate-800 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 shadow-3xs transition-all duration-200"
                  >
              ...
              <div className="flex flex-col items-center justify-center pt-4">
                <div className="text-[10px] font-black text-blue-600 tracking-tight mb-1 bg-blue-50/80 px-1.5 py-0.5 rounded-sm border border-blue-100">方向</div>
            ...
            <div className="bg-white border border-indigo-100/50 p-2.5 rounded-md flex items-center justify-between text-xs text-slate-600">
              <span className="font-extrabold text-[11px]">链路表示:</span>
              <div className="flex items-center gap-2 font-mono font-black text-indigo-700 bg-indigo-50/50 px-2 py-1 rounded-sm">
                <span>{sourceObj}</span>
            ...
            <div className="pt-3 border-t border-slate-200/60">
              <div className="flex items-center justify-between">
                ...
                <div className="flex bg-white rounded-md border border-slate-200/60 p-0.5 shadow-3xs">
                  {(['1:1', '1:N', 'N:N'] as const).map(card => (
                    <button 
                      key={card}
                      type="button"
                      onClick={() => setCardinality(card)}
                      className={`px-3 py-1 font-mono text-[11.5px] font-bold rounded-sm transition-all cursor-pointer ${
                        cardinality === card 
              ...
              <p className="text-[11px] text-slate-500 mt-2 font-medium leading-relaxed bg-slate-100/40 p-2 rounded-md border border-slate-200/30">
            ...
            {[
              ...
              >
                <input 
                  ...
                  className="rounded border-slate-300 text-blue-600 focus:ring-blue-500 mt-0.5 shrink-0 cursor-pointer"
                />
          ...
          <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <select 
                    ...
                    className="w-full pl-3 pr-8 py-2 bg-slate-50/45 hover:bg-slate-50/80 focus:bg-white border border-slate-200 hover:border-slate-300 rounded-md text-xs text-slate-800 font-bold appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 transition-all duration-200 shadow-3xs"
                  >
                    {roleOptions.map(opt => (
                      <option key={opt} value={opt}>{opt}</option>
                    ))}
            ...
            <div className="grid grid-cols-2 gap-4 pt-2 border-t border-slate-100/80">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex bg-slate-100 rounded-md border border-slate-200/60 p-0.5 h-[34px] shadow-3xs">
                  <button 
                    type="button"
        ...
        {/* Block 5: 校验与影响分析 */}
        <section className="bg-indigo-50/20 border border-slate-200/40 p-5 rounded-md shadow-3xs space-y-4">
          <div className="flex items-center gap-2 mb-2 border-b border-indigo-100/40 pb-2">
            <Layers className="w-4.5 h-4.5 text-indigo-600" />
            <h3 className="text-xs font-black text-slate-800">第五块：校验与影响分析</h3>
          </div>
          
          <div className="space-y-2.5">
            {/* Rule 1: Source object state validation */}
            <div className="bg-emerald-50/60 border border-emerald-100/50 p-3 rounded-md flex items-start gap-3">
            ...
            {isTargetInDknDomain ? (
              <div className="bg-emerald-50/60 border border-emerald-100/50 p-3 rounded-md flex items-start gap-3 animate-fade-in">
                <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5 bg-emerald-100/50 rounded-full p-0.5" />
                <div className="text-xs">
              ...
              <div className="bg-amber-50 border border-amber-100 p-3 rounded-md flex items-start gap-3 animate-fade-in">
            ...
            <div className="bg-blue-50/40 border border-blue-100 p-3 rounded-md flex items-start gap-3">
            ...
            <div className="bg-indigo-50/40 border border-indigo-100 p-3 rounded-md flex items-start gap-3">
      ...
      <div className="p-5 border-t border-slate-200 bg-slate-50 flex justify-end gap-3 shrink-0">
        <button 
          onClick={onClose}
          className="px-5 py-2 text-xs font-black text-slate-700 bg-white border border-slate-200/50 hover:bg-slate-50/50 hover:text-slate-900 rounded-md shadow-xs hover:border-slate-300/80 transition-all cursor-pointer"
        >
          取消
        </button>
        <button 
          ...
          className="px-5 py-2 text-xs font-black text-white bg-blue-600 hover:bg-blue-700 shadow-sm rounded-md transition-all flex items-center gap-1.5 cursor-pointer disabled:opacity-45 disabled:cursor-not-allowed"
        >
          保存到变更集
        </button>
      </div>
