        ...
        <div className="mb-5 space-y-1.5 shrink-0">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button className="px-3.5 py-1.5 text-xs font-bold text-slate-650 bg-white border border-slate-200 hover:bg-slate-50 rounded-lg shadow-3xs transition-all flex items-center gap-1.5 cursor-pointer">
